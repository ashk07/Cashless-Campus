...
public class ExampleAdapterC extends RecyclerView.Adapter<ExampleAdapterC.ExampleViewHolder> {
    private List<ExampleItem5> exampleList;
    ...
    public ExampleAdapterC(List<ExampleItem5> exampleList2, Context context) {
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ...
        final ExampleItem5 currentItem = (ExampleItem5) this.exampleList.get(position);
