...
import com.example.cashlessCampus.ExampleAdapter4;
...
public class TransactionHistoryAdmin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_transaction_history_admin, container, false);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                recyclerView.setHasFixedSize(true);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
                adapter = new ExampleAdapter4(exampleList,getActivity());
                recyclerView.setLayoutManager(layoutManager);
    ...
    private void fillExampleList() {
        ...
        String url = UrlLinks.getAllHistory;
        List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(1);

        nameValuePairs.add(new BasicNameValuePair("userid", "admin"));
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                String sname = String.valueOf(jsonArray.getJSONArray(i).getString(1));
                ...
                exampleList.add(new ExampleItem2(pname,pcat,datetime,pprice,sname));
    ...
    public void filterQuery(String text) {
        ...
        for (ExampleItem2 s : exampleList) {
            if (s.getText1().toLowerCase().contains(text) || s.getText2().toLowerCase().contains(text) || s.getText3().toLowerCase().contains(text) || s.getText5().toLowerCase().contains(text)) {
                filterdNames.add(s);
            }
        }
