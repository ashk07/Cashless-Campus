...
public class updateEvents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            SpannableString spannableString = new SpannableString("Update Event");
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(title1.equals("") || price1.equals("")){
                    ...
                    if (result.equals("success")) {
                        Snackbar.make(v, "Event updated.", Snackbar.LENGTH_LONG).setAction("Action", null).show();
                    } else {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_GALLERY && resultCode == Activity.RESULT_OK) {
            String filePath = getRealPathFromUri(data.getData(), updateEvents.this);
    ...
    private void SaveImage(Bitmap finalBitmap) {
        ...
        ContextWrapper cw = new ContextWrapper(updateEvents.this);
        ...
        Snackbar.make(updateEvents.this.findViewById(android.R.id.content),  "File uploaded.", Snackbar.LENGTH_LONG).setAction("Action", null).show();
    ...
    private Boolean checkStoragePermission() {
        boolean result = ContextCompat.checkSelfPermission(updateEvents.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
        return result;
    }
    ...
    private Boolean checkCameraPermission() {
        boolean result = ContextCompat.checkSelfPermission(updateEvents.this, Manifest.permission.CAMERA) == (PackageManager.PERMISSION_GRANTED);
        boolean result1 = ContextCompat.checkSelfPermission(updateEvents.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
