...
public class ExampleAdapterS extends RecyclerView.Adapter<ExampleAdapterS.ExampleViewHolder> {
    private List<ExampleItem5> exampleList2;
    ...
    public ExampleAdapterS(List<ExampleItem5> exampleList2, Context context) {
       // this.mContext = context;
        this.exampleList2 = exampleList2;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ...
        final ExampleItem5 currentItem = (ExampleItem5) this.exampleList2.get(position);
