...
public class ExampleAdapterE extends RecyclerView.Adapter<ExampleAdapterE.ExampleViewHolder> {
    private List<ExampleItem5> exampleList3;
    ...
    public ExampleAdapterE(List<ExampleItem5> exampleList2, Context context) {
       // this.mContext = context;
        this.exampleList3 = exampleList2;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ...
        final ExampleItem5 currentItem = (ExampleItem5) this.exampleList3.get(position);
