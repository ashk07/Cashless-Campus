...
public class ExampleAdapter4 extends RecyclerView.Adapter<ExampleAdapter4.ExampleViewHolder> {
    ...
    public ExampleAdapter4(List<ExampleItem2> exampleList2, Context context) {
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ...
        holder.textView1.setText(currentItem.getText5());
        holder.textView2.setText(currentItem.getText1());
